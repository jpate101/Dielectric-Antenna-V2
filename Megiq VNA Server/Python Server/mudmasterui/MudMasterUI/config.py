...
class Config(object):
    ...
    MACHINE_DIRECTORY = r'C:\Users\JoshuaPaterson\OneDrive - Phibion Pty Ltd\Documents\GitHub\Dielectric-Antenna-V2\Megiq VNA Server\movedTouchstoneFilesLocation'
