...
# Example usage
main_folder = r'C:\Users\JoshuaPaterson\Phibion Pty Ltd\IG88 - General\03 Development\Dielectric Antenna\Predictive Model Training Guide and FIles\Data Processing Scripts\MT_WELD_OUTPUT'
...
checkpoint = ModelCheckpoint('50_DNN_MT_WELD_Testing_D2OnlyCheck.keras', save_best_only=True, monitor='val_loss', mode='min')
...
# Save the model
model.save('50_DNN_MT_WELD_Testing_D2Only.keras')
