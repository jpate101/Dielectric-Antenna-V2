...
# Bring the window to the foreground and send keystrokes
try {
    ...
    [System.Windows.Forms.SendKeys]::SendWait("{TAB}") # Send {TAB}
    ...
    [System.Windows.Forms.SendKeys]::SendWait("{ENTER}") # Send {TAB}
    ...
    [System.Windows.Forms.SendKeys]::SendWait("3") # Send {TAB}

    Start-Sleep -Milliseconds 700 # Wait for the menu to open

    [System.Windows.Forms.SendKeys]::SendWait("0") # Send {TAB}
    #Start-Sleep -Milliseconds 500 # Wait for the menu to open
